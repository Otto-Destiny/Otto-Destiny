![Destiny Otto profile banner](assets/profile-signal.svg)
...
```mermaid
flowchart LR
    A[AI Systems] --> A1[GraphRAG]
    A --> A2[Agents]
    A --> A3[LLMs and CV]

    B[Data Science and ML] --> B1[Forecasting]
    B --> B2[Recommenders]
    B --> B3[Experimentation]

    C[Engineering Intelligence] --> C1[Drilling]
    C --> C2[Reservoir]
    C --> C3[Production]

    D[Scientific Computation] --> D1[Phase behavior]
    D --> D2[Numerical methods]
    D --> D3[Physics-guided ML]

    A1 --> E[Decision products]
    B1 --> E
    C3 --> E
    D3 --> E
```
...
<p align="center">
  <img alt="GitHub stats" src="https://github-readme-stats.vercel.app/api?username=Otto-Destiny&show_icons=true&hide_border=true&rank_icon=github&theme=github_dark">
</p>
